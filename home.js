...
console.log((greetUser("Penny"))) 
console.log(canWeDeliver(84118))
console.log("================")
/* 
    Problem 2 Continued
...
//             console.log(`You're in our delivery zone!`) //return "You're in our delivery zone!"
//         }
//         // return `Sorry, we can't deliver to that address.`
//         else{
//             console.log(`Sorry, we can't deliver to that address.`)
