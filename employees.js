...
class Employee {
    constructor(name,shifts){
        this.name = name;
        this.shifts = shifts; //can used spread operator [...shifts]
    }
    getSchedule(){
        console.log(`${this.name} works on ${this.shifts}`)
    }
}
let jordan = new Employee("Jordan Hansen", [`Tuesday 09:00-17:00`, `Thursday 15:00-00:00`])
/*
...
class Manager extends Employee {
    ...
    addEmployee(employee){
        ...
        console.log(`${employee} has been added to ${this.name}'s list.`)
    }
}
